...
- Name: site.spec.ts >> Protected Route Soft-Gate >> [AdminDashboard] redirects unauthenticated users to /login
- Location: src\e2e\tests\site.spec.ts:84:5

# Error details

```
Error: AdminDashboard did NOT redirect unauthenticated user. Still on: http://localhost:5173/admin
