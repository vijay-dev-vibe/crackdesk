...
- Name: site.spec.ts >> Protected Route Soft-Gate >> [MockTest] redirects unauthenticated users to /login
- Location: src\e2e\tests\site.spec.ts:84:5

# Error details

```
Error: MockTest did NOT redirect unauthenticated user. Still on: http://localhost:5173/mock-test
...
- generic [ref=e2]:
  ...
  - generic [ref=e4]:
    ...
    - main [ref=e37]:
      - generic [ref=e38]:
        - generic [ref=e40]:
          - heading "AI Mock Test Generator" [level=1] [ref=e41]
          - paragraph [ref=e42]: Paste a job description and AI will craft a personalised 20-question assessment.
        - generic [ref=e44]:
          - textbox "Paste the full job description or enter a topic (e.g. 'React Developer', 'Data Science', 'Product Manager')..." [disabled] [ref=e45]
          - button "Monthly limit reached — Upgrade to continue" [disabled]
    - contentinfo [ref=e46]:
      - generic [ref=e47]:
        - generic [ref=e48]:
          - generic [ref=e49]:
            - link "MapReducer by Minimize Technology Pvt. Ltd." [ref=e50] [cursor=pointer]:
              - /url: /
              - generic [ref=e59]:
                - text: MapReducer
                - generic [ref=e60]: by Minimize Technology Pvt. Ltd.
            - paragraph [ref=e61]: AI-powered mock tests tailored to your dream job description.
          - generic [ref=e62]:
            - heading "Product" [level=4] [ref=e63]
            - generic [ref=e64]:
              - link "JD Mock Test" [ref=e65] [cursor=pointer]:
                - /url: /mock-test
              - link "Test Library" [ref=e66] [cursor=pointer]:
                - /url: /test-library
              - link "Test History" [ref=e67] [cursor=pointer]:
                - /url: /test-history
          - generic [ref=e68]:
            - heading "Company" [level=4] [ref=e69]
            - generic [ref=e70]:
              - generic [ref=e71]: About Us
              - generic [ref=e72]: Careers
              - generic [ref=e73]: Contact
          - generic [ref=e74]:
            - heading "Legal" [level=4] [ref=e75]
            - generic [ref=e76]:
              - generic [ref=e77]: Privacy Policy
              - generic [ref=e78]: Terms of Service
        - generic [ref=e79]: © 2026 Minimize Technology. All rights reserved.
```
